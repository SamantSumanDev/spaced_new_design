...
class SecondMyAdapter(private val items: ArrayList<Item>, private val viewPager: ViewPager2) : RecyclerView.Adapter<SecondMyAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (position == selectedItem) {
            holder.textView.setTextSize(TypedValue.COMPLEX_UNIT_SP, 80f)
            ...
            holder.textView.setTextSize(TypedValue.COMPLEX_UNIT_SP, 40f)
